...
<div class="table-container-wrapper">
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td class="sticky-col header-cell-param">Launch sector: [degrees]</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
          >
            {{ weapon.launch_sector || '-' }}
          </td>
        </tr>
        <tr>
          <td class="sticky-col header-cell-param">Guidance FOV: [degrees]</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
        ...
        <tr>
          <td class="sticky-col header-cell-param">Guidance max lead: [degrees]</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
          >
            {{ weapon.guidance_max_lead || '-' }}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="sticky-col header-cell-param">Max lateral acceleration:</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
          >
            {{ weapon.max_lateral_acceleration || '-' }}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="sticky-col header-cell-param">Thrust vectoring angles: [degrees]</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
          >
            {{ weapon.thrust_vectoring_angles || '-' }}
          </td>
        </tr>
        <tr>
