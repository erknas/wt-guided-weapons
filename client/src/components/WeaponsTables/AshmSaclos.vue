...
<div class="table-container-wrapper">
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td class="sticky-col header-cell-param">Guidance launch sector: [degrees]</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
          >
            {{ weapon.guidance_launch_sector || '-' }}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="sticky-col header-cell-param">Aim tracking sensitivity:</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell"
          >
            {{ weapon.aim_tracking_sensitivity || '-' }}
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="sticky-col header-cell-param">Has a tracer in its tail:</td>
          <td 
            v-for="weapon in weapons" 
            :key="weapon.id"
            class="data-cell text-center"
          >
            {{ weapon.has_tracer_in_tail || '-' }}
          </td>
        </tr>
        <tr>
