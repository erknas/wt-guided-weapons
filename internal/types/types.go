...
type Weapon struct {
	...
	LaunchSector                            string `json:"launch_sector,omitempty"`
	...
	DragCoefficientMultiplierBomb           string `json:"drag_coefficient_multiplier_bomb,omitempty"`
	...
	ThrustVectoringAngles                   string `json:"thrust_vectoring_angles,omitempty"`
	MaximumLaunchAngleHorizontalVertical    string `json:"maximum_launch_angle_horizontal_vertical,omitempty"`
	MaximumLaunchAngle                      string `json:"maximum_launch_angle,omitempty"`
	...
	LoftA                                   string `json:"loft_a,omitempty"`
	TargetElevation                         string `json:"target_elevation,omitempty"`
	TargetE                                 string `json:"target_e,omitempty"`
	...
	ETAtoImpactWhenSeaAltitudeReachesMetres string `json:"eta_to_impact_when_sea_altitude_reaches_metres,omitempty"`
